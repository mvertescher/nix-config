...
//!
//!     cyberpunk-ui-mailbox                # follow the desktop theme
//!     cyberpunk-ui-mailbox --era kitsch   # force one
//!
//! See examples/cyberpunk-ui-store.rs for the reasoning behind the
//! --era handling; it is the same here.

use cyberpunk_ui::screens::mail::{Message, MailBox};
...
fn main() -> iced::Result {
    ...
    iced::application(MailBox::title, MailBox::update, MailBox::view)
        ...
        .antialiasing(true)
        .run_with(move || (MailBox::new(style), iced::Task::none()))
}
