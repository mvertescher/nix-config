...
| ~~`docs/neomil/target-components.svg`~~ | **Deleted 2026-09-03.** Claimed to be "sampled across the run" but sampled nothing from it — every component was the composites' invention. The other three eras' component sheets remain, by-eye and unverified. |
