...
| SVG | traced from |
|---|---|
| `docs/neokitsch/dashboard-trace.svg` | `images/neokitsch-dashboard.png` — **G1 schematic**, written 2026-09-01 from measured geometry: six 91.7x328 cards (top-right chamfer 42.5, one 45° diagonal across the whole foot, a 6x38 solid plate on the left edge) in staircase triplets at (246,384)(347,284)(449,182) and (624,384)(724,284)(826,182), EMAIL solid gold with a plate well and no rings, the five unselected cards each carrying six onion outlines nested inside the card, sharing its left edge and foot (re-measured against the photo 2026-09-03: this row had "93x327, chamfer top-right + bottom-left, concentric outward rings"; the old `#ncard` was an 83 body plus a 10 tab well with a 32 chamfer, and the rings were offset outward); detail panel at (1170.8,259.7): 230.4x465.3 with a stepped top edge (shoulder at the left climbing through an S-curve to the top line), four onion rings nested inside, solid body [1170.8,326,230.4,309] and the EMAIL label beneath (re-measured 2026-09-03 late; this row had "(1168,253)" and the trace had the cascade card mirrored with a 42 chamfer and six rings offset outward, none of it in the photo); wire band, letter boxes, T1–T4 badges. Gated by ink placement: 0.60 (0.51–0.54 before the halo filter shared with the three newer traces was ported in, 2026-09-02; re-run 2026-09-03: 0.67 after the card, 0.68 after the panel) vs 0.03 for the old app composite. |
